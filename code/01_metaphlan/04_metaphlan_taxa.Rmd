...
```{r, message=TRUE}
ps_up %>% 
  subset_samples(Time == "TP2" & Sample == "Plaque" & Inflamation_response %in% c("Low", "High") ) %>% 
  phyloseq_diff_abundance(ps_tmp = .,
                          approach = c( "maaslin3"),
                          glom = "Species",
                          # maaslin3_fixed_effects = ,
                          # maaslin3_strata_effects = ,
                          # masslin3_output_dir = ,
                          taxa_rank = "all", #"OTU"
                          comp_group = "Inflamation_response",
                          formula =  "~ Inflamation_response",
                          palette = sample_pal,
...
ps_up %>% 
  ...
  phyloseq_diff_abundance(ps_tmp = .,
                          approach = c( "maaslin3","run_lefse", "run_ancom", "trans_diff_rf", "ancombc2", "linda"),
                          glom = "Species",
                          taxa_rank = "all", #"OTU"
                          comp_group = "Sample",
                          formula =  "~ Sample",
